...
dw $0000 // RESERVED
dw $0000 // RESERVED
dw _cop  // COP VECTOR   (COP Opcode)
dw _brk  // BRK VECTOR   (BRK Opcode)
dw $0000 // ABORT VECTOR (Unused)
dw _nmi  // NMI VECTOR   (V-Blank Interrupt)
dw $0000 // RESET VECTOR (Unused)
dw _irq  // IRQ VECTOR   (H/V-Timer/External Interrupt)
...
dw _rst  // RESET VECTOR (CPU is always in 6502 mode on RESET)
